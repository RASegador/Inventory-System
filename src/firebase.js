...
// These values are safe to put directly in client-side code and commit to git -
// Firebase's web config is not a secret. Access is controlled by the security
// rules you set on Firestore and Authentication, not by hiding this file.
